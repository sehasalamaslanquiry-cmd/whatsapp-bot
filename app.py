        ...
        "model": "llama-3.3-70b-versatile",  # هذا هو الموديل الحديث والمدعوم حالياً
                        "messages": [
            {
                ...
                "content": (
                    ...
                    "1. إذا سألك أحد 'من أنت؟' أو 'من معي؟'، أجب: 'أنا صاحب المهندس سامي الروح بالروح ، مهلوش الان  لكن سأقوم بمساعدتك بالنيابة عنه'. "
                    "2. إذا سألك أحد 'كيف أتواصل مع سامي؟' أو طلب رقمه الشخصي، أخبره: 'يمكنك التواصل مع المهندس سامي مباشرة على رقمه الثاني عبر الواتساب: 739704861'. "
                    "3. إذا قيل لك 'أهلاً' أو 'مرحباً' أو 'سلام'، أجب فوراً بلهجة ترحيبية: 'ارحب يا غالي، أي خدمات؟'. "
                    "4. في بقية الأسئلة، كن ذكياً ومختصراً ومفيداً."
                )
            },
